...
namespace GameJam.Core
{
	...
	public class Level : SerializedScriptableObject
	{
		...
		public Dictionary<Vector2Int, Cell> Board = new Dictionary<Vector2Int, Cell> {
			...
			{ new Vector2Int(4, 5), new Cell { Terrain = 1, Structure = 1 } },
			{ new Vector2Int(4, 6), new Cell { Terrain = 1, Structure = 1 } },
			{ new Vector2Int(4, 7), new Cell { Terrain = 1, Structure = 1 } },
			{ new Vector2Int(4, 8), new Cell { Terrain = 1, Structure = 1 } },
			{ new Vector2Int(4, 9), new Cell { Terrain = 1, Structure = 1 } },
			...
			{ new Vector2Int(5, 4), new Cell { Terrain = 1, Structure = 1 } },
			{ new Vector2Int(5, 5), new Cell { Terrain = 1, Structure = 1 } },
			{ new Vector2Int(5, 6), new Cell { Terrain = 1, Structure = 1 } },
			{ new Vector2Int(5, 7), new Cell { Terrain = 1, Structure = 1 } },
			{ new Vector2Int(5, 8), new Cell { Terrain = 1, Structure = 1 } },
