...
namespace GameJam.Core
{
	...
	public class Level : SerializedScriptableObject
	{
		...
		public Dictionary<Vector2Int, Cell> Board = new Dictionary<Vector2Int, Cell> {
			...
			{ new Vector2Int(0, 4), new Cell { Structure = 9 } },
			{ new Vector2Int(0, 5), new Cell { Structure = 99 } },
			...
			{ new Vector2Int(1, 2), new Cell { Structure = 0, Fire = 1 } },
			{ new Vector2Int(1, 3), new Cell { } },
			{ new Vector2Int(1, 4), new Cell { Structure = 9 } },
			...
			{ new Vector2Int(2, 4), new Cell { Structure = 9 } },
			{ new Vector2Int(2, 5), new Cell { Structure = 0 } },
			{ new Vector2Int(2, 6), new Cell { Structure = 0 } },
			{ new Vector2Int(2, 7), new Cell { Structure = 0 } },
			{ new Vector2Int(2, 8), new Cell { Structure = 0 } },
			{ new Vector2Int(2, 9), new Cell { Structure = 99 } },

			{ new Vector2Int(3, 0), new Cell { } },
			{ new Vector2Int(3, 1), new Cell { } },
			{ new Vector2Int(3, 2), new Cell { } },
			{ new Vector2Int(3, 3), new Cell { } },
			{ new Vector2Int(3, 4), new Cell { Structure = 9 } },
			{ new Vector2Int(3, 5), new Cell { Structure = 0 } },
			...
			{ new Vector2Int(4, 5), new Cell { Structure = 99 } },
