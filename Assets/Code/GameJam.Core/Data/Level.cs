...
namespace GameJam.Core
{
	...
	public class Level : SerializedScriptableObject
	{
		...
		// Start : 	{ Structure = 0, Terrain = 99, Fire = 1 }
		// Tree :	{ Structure = 0 }
		// Rock : 	{ Structure = 9 }
		// Exit : 	{ Structure = 99 }
		...
		public Dictionary<Vector2Int, Cell> Board = new Dictionary<Vector2Int, Cell> {
			...
			{ new Vector2Int(0, 5), new Cell { Structure = 9, } },
			...
			{ new Vector2Int(1, 1), new Cell { Structure = 0, Terrain = 99, Fire = 1 } },
			{ new Vector2Int(1, 2), new Cell { } },
			{ new Vector2Int(1, 3), new Cell { } },
			{ new Vector2Int(1, 4), new Cell { Structure = 9 } },
			{ new Vector2Int(1, 5), new Cell { Structure = 9 } },
			...
			{ new Vector2Int(2, 5), new Cell { Structure = 9, } },
			{ new Vector2Int(2, 6), new Cell { } },
			{ new Vector2Int(2, 7), new Cell { } },
			{ new Vector2Int(2, 8), new Cell { Structure = 99 } },
			{ new Vector2Int(2, 9), new Cell { } },

			{ new Vector2Int(3, 0), new Cell { } },
			{ new Vector2Int(3, 1), new Cell { Structure = 99 } },
			...
			{ new Vector2Int(4, 4), new Cell { Structure = 9 } },
			{ new Vector2Int(4, 5), new Cell {  } },
			{ new Vector2Int(4, 6), new Cell { } },
			{ new Vector2Int(4, 7), new Cell { } },
			{ new Vector2Int(4, 8), new Cell { Structure = 0, Terrain = 99, Fire = 1 } },
			...
			{ new Vector2Int(5, 4), new Cell { Structure = 9 } },
