...
namespace GameJam.Core
{
	...
	public class Level : SerializedScriptableObject
	{
		...
		public Dictionary<Vector2Int, Cell> Board = new Dictionary<Vector2Int, Cell> {
			...
			{ new Vector2Int(0, 4), new Cell { Terrain = 1 } },
			{ new Vector2Int(0, 5), new Cell { Terrain = 1 } },
			{ new Vector2Int(0, 6), new Cell { Terrain = 1 } },
			{ new Vector2Int(0, 7), new Cell { Terrain = 1 } },
			{ new Vector2Int(0, 8), new Cell { Terrain = 1 } },
			{ new Vector2Int(0, 9), new Cell { Terrain = 1 } },
			...
			{ new Vector2Int(1, 4), new Cell { Terrain = 1 } },
			{ new Vector2Int(1, 5), new Cell { Terrain = 1 } },
			{ new Vector2Int(1, 6), new Cell { Terrain = 1 } },
			{ new Vector2Int(1, 7), new Cell { Terrain = 1 } },
			{ new Vector2Int(1, 8), new Cell { Terrain = 1 } },
			{ new Vector2Int(1, 9), new Cell { Terrain = 1 } },

			{ new Vector2Int(2, 0), new Cell { Terrain = 1 } },
			{ new Vector2Int(2, 1), new Cell { Terrain = 1 } },
			{ new Vector2Int(2, 2), new Cell { Terrain = 1 } },
			...
			{ new Vector2Int(3, 2), new Cell { Terrain = 1 } },
			...
			{ new Vector2Int(4, 2), new Cell { Terrain = 1 } },
			{ new Vector2Int(4, 3), new Cell { Terrain = 1 } },
			...
			{ new Vector2Int(5, 2), new Cell { Terrain = 1 } },
			{ new Vector2Int(5, 3), new Cell { Terrain = 1 } },
